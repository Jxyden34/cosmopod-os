...
```powershell
.\scripts\build.ps1 -Board pi4 -Channel development -Version 0.38.0
```
...
sha256sum out/0.38.0/pi4-release/SHA256SUMS
sha256sum out/0.38.0/pi4-release/Cosmopod-OS-0.38.0-pi4-unsigned.mender
...
scripts/sign-release.sh \
  ...
  out/0.38.0/pi4-release/Cosmopod-OS-0.38.0-pi4-unsigned.mender
```
...
openssl dgst -sha256 -verify \
  ...
  -signature out/0.38.0/pi4-release/SHA256SUMS.sig \
  out/0.38.0/pi4-release/SHA256SUMS
```
